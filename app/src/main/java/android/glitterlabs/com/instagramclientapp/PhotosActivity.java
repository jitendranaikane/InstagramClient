                 ...
                 try
                 {
                   photosJSON=response.getJSONArray("data"); //gives array of photos item.
                     ...
                     for(int i=0;i<photosJSON.length();i++)
                     {
                         ...
                         photo.imageProfile=photoJSON.getJSONObject("user").getString("profile_picture");
                         photo.comments=photoJSON.getJSONObject("comments").getJSONArray("data").getJSONObject(1).toString();




                       //  Log.e("List","" +photos); Log.i("ImageProofile);
                         Log.i("Comment",""+photo.comments);
                     }
